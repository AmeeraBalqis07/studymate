...
<body>
  ...
  <div class="sidebar" id="sidebar">
    ...
    ?>"> DASHBOARD </a></p>
     ...
     <ul id="sidebar-list">
      <li class="draggable" id="section1">
        <a href="profile.php">● Profile</a>
      </li>
      <li class="draggable" id="section2">
        <a href="<?php 
    if (isset($_SESSION['role'])) {
        if ($_SESSION['role'] == 'student, lecturer') {
            echo 'announcement.php'; 
        } elseif ($_SESSION['role'] == 'admin') {
    ...
    ?>">● Announcement</a>
      ...
      <li class="draggable" id="section3">
        <a href="<?php 
    if (isset($_SESSION['role'])) {
        if ($_SESSION['role'] == 'student, lecturer') {
            echo 'discussionforum.php'; 
    ...
    ?>">● Forum Discussion</a></li>
      ...
      <li class="draggable" id="section4">
        <a href="<?php 
    if (isset($_SESSION['role'])) {
    ...
    ?>">● Material Search</a></li>
      ...
      <li class="draggable" id="section5">
  ...
  <script>
    ...
    function toggleSidebar() {
      ...
      if (sidebar.classList.contains("active")) {
        mainContent.style.marginLeft = "10px"; // Shift content to the right
      } else {
        mainContent.style.marginLeft = "260px"; // Content returns to original position
      }
    }
